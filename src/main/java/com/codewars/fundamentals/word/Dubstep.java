 ...
 * this song, Polycarpus inserts a certain number of words "WUB" before the first word of the song (the number
...
public class Dubstep {
    public static String SongDecoder(String song) {
        return song.replaceAll("WUB", " ").replaceAll("\\s{1,}", " ").trim();
    }

    /**
     * Best solution on CodeWars
     */
    public static String SongDecoderCodeWars(String song) {
