...
/**
 * In this kata, your task is to create a regular expression capable of evaluating binary strings (strings with
 * only 1s and 0s) and determining whether the given string represents a number divisible by 3.
 * <p>
 * Take into account that:
 * <p>
 * An empty string might be evaluated to true (it's not going to be tested, so you don't need to worry
 * about it - unless you want)
